    ...
    <section id="product" className={`${layout.sectionReverse} `}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <div className="flex flex-row flex-wrap mt-6 sm:mt-10">
          <img src={apple} alt="apple__store" className="w-[128px] h-[42px] cursor-pointer mr-5 object-contain" />
          <img src={google} alt="google__store" className="w-[128px] h-[42px] cursor-pointer  object-contain" />
        </div>
      </div>
    </section>
  );
